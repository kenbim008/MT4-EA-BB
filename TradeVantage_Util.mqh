...
// double m1currentLots;
// int m1lossCount;
// double m1dailyProfit;
// double m1weeklyProfit;
// double m1monthlyProfit;
// datetime m1lastDailyUpdate;
// datetime m1lastWeeklyUpdate;
// datetime m1lastMonthlyUpdate;
// //+------------------------------------------------------------------+
// //| Get Trend Direction                                              |
// //+------------------------------------------------------------------+
// string GetTrendDirection(int movPeriod, int movShift)
//   {
//    double ma = iMA(NULL, 0, movPeriod, movShift, MODE_SMA, PRICE_CLOSE, 0);
...
// //+------------------------------------------------------------------+
// void TrailingStopManagement(double TrailingStop, double TrailingStep)
//   {
...
// //+------------------------------------------------------------------+
// void EAR3_CheckForClose(int movPeriod, int movShift)
//   {
//    double ma;
// //--- go trading only for first tiks of new bar
//    if(Volume[0]>1) return;
// //--- get Moving Average 
//    ma=iMA(NULL,0,movPeriod,movShift,MODE_SMA,PRICE_CLOSE,0);
// //---
//    for(int i=0;i<OrdersTotal();i++)
//      {
//       if(OrderSelect(i,SELECT_BY_POS,MODE_TRADES)==false) break;
...
// void EAR3_CheckForOpen(int movPeriod, int movShift )
//   {
//    double ma;
//    int    res;
// //--- go trading only for first tiks of new bar
...
//      {
//       res=OrderSend(Symbol(),OP_SELL,m1currentLots,Bid,3,0,0,"",MAGICMA,0,Red);
//       if(res<0)
...
//    if(Open[1]<ma && Close[1]>ma)
//      {
//       res=OrderSend(Symbol(),OP_BUY,m1currentLots,Ask,3,0,0,"",MAGICMA,0,Blue);
//       if(res<0)
